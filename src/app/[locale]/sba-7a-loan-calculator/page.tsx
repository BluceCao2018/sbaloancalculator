      ...
      <div className="banner bg-blue-theme py-16">
        ...
        <section className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white mb-8">
            Calculate your SBA 7(a) loan payments with current rates. 
            Free business loan calculator for working capital, equipment, and real estate.
          </p>
        </section>
      </div>
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <section className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p>
              The SBA 7(a) loan program is the SBA's primary program for providing financial assistance
              to small businesses. The program offers:
            </p>
            <ul>
              <li>Flexible terms and uses</li>
              <li>Working capital financing</li>
              <li>Real estate and equipment purchases</li>
              <li>Debt refinancing options</li>
            </ul>
          </div>
        </section>
